...
const technologies = ['React.js', 'JS', 'CSS', 'HTML', 'Adaptive Design']
    ...
    <main className={styles.main}>
      ...
      <section className={styles.experience}>
        ...
        <Typography variant="body1" weight="regular">
          ...
          Seeing a project evolve from an idea into a useful product was both
          motivating and rewarding. It also reinforced an important lesson:
          tasks that initially seem difficult often become valuable learning
          opportunities, helping build confidence, problem-solving skills, and a
          desire to take on increasingly complex challenges.
        </Typography>
      </section>
      <section className={styles.experience}>
        <Typography
        ...
        <Typography variant="body1" weight="regular">
          ...
          interface myself. A significant amount of time was spent bridging the
          gap between how I envisioned the design and how it ultimately appeared
          on screen. Through this process, I gained a greater appreciation for
          UI/UX design and the importance of visual consistency, accessibility,
          and color harmony. This experience made me especially interested in
          future collaboration with designers, where design concepts and
          implementation can complement each other more effectively.
        </Typography>
      </section>
      <section className={styles.features}>
        ...
        <div className={styles.featuresContainer}>
          ...
          <Typography
            ...
            weight="regular"
          >
            Implemented user registration, login, logout, and protected routes.
            Access to specific pages and functionality is restricted based on
            the user's authentication status and permissions.
          </Typography>
        ...
        <div className={styles.featuresContainer}>
          ...
          >
            ...
            corresponding pet's profile. <br />• Pet Management Overview — view
            existing pets, access detailed pet profiles, and add new pets.
          </Typography>
          <Typography as="h5" variant="body1" weight="regular">
          ...
          >
            ...
            backend data with an "Other" fallback option for unsupported breeds.{' '}
            <br />
        ...
        <div className={styles.featuresContainer}>
          ...
          >
            ...
            <br />
            -- Feeding Records — maintain a history of feeding-related entries.
            <br />
          ...
          <Typography
            ...
            weight="regular"
          >
            -- Treatment Scheduling System — manage medications and vaccinations
            with support for one-time and recurring schedules. <br />
            ...
            <br />
            --Expandable Vaccination History — vaccination records are collapsed
            after the first three entries, with additional items accessible via
            a "Show More" option.
          </Typography>
          <div className={styles.carouselContainer}>
        ...
        <div className={styles.featuresContainer}>
          ...
          >
            ...
            -- Measurement Units Configuration — customize preferred measurement
            units. <br />
